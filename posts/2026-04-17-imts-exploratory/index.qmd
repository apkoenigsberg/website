...
date: "2026-04-17"
categories: [trade, conflict, anomaly-detection, imf-imts, acled, python]
...
```{python}
#| label: fig-countries
#| fig-cap: "2×2 country panels for the three profile countries."
DEEPDIVE = ["UKR", "VEN", "YEM"]
for code in DEEPDIVE:
    _plot_country(code, TARGETS[code])
```
